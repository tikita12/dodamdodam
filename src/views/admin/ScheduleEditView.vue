        ...
        <div class="relative">
          ...
          <div class="flex items-center justify-between mt-2 pt-0.5">
            ...
            <button
              ...
              class="px-3 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-xl text-xs font-bold flex items-center gap-1.5 transition active:scale-95 cursor-pointer border border-blue-200/60 shadow-2xs"
            >
